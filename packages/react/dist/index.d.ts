...
declare const TooltipProvider: _stitches_react_types_styled_component.StyledComponent<react.FC<Tooltip$1.TooltipProviderProps>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
interface TooltipProviderProps extends ComponentProps<typeof TooltipProvider> {
}
...
declare function Toast({ title, content, ...props }: ToastProps): JSX.Element;
declare namespace Toast {
    var displayName: string;
}

declare const ToastProvider: _stitches_react_types_styled_component.StyledComponent<react.FC<Toast$1.ToastProviderProps>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
interface ToastProviderProps extends ComponentProps<typeof ToastProvider> {
}

export { Avatar, AvatarProps, Box, BoxProps, Button, ButtonProps, Checkbox, CheckboxProps, Heading, HeadingProps, MultiStep, MultiStepProps, Text, TextArea, TextAreaProps, TextInput, TextInputProps, TextProps, Toast, ToastProps, ToastProvider, ToastProviderProps, Tooltip, TooltipProps, TooltipProvider, TooltipProviderProps };
